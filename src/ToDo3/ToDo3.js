...
import ToDo3Item from "./Todo3Item";
...
const ToDo3 = ({toDos, addToDo, deleteTodo, updateTodo, filterName, changeFilterName, importantTodo, doneTodo, changeSearchValue}) => {
            ...
            >
                <div className={style.ToDoItemWrap}>
                    <img src={rewriteIco} alt="" onClick={!item.done && !toDo.id && !value
                        ...
                        : null}/>
                    <ToDo3Item toDoText={item.toDoText} done={item.done} important={item.important}
